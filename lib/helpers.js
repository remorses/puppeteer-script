...
exports.waitForElement = function (element) { return __awaiter(_this, void 0, void 0, function () {
    var isMoving, box, x, newx, y, newy, width, newwidth, height, newheight;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                isMoving = true;
...
exports.ifThen = function (check, fun) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!!check) return [3 /*break*/, 2];
                return [4 /*yield*/, fun(check)];
            case 1: return [2 /*return*/, _a.sent()];
            case 2: return [2 /*return*/, null];
        }
    });
}); };
exports.preparePage = function (page) { return __awaiter(_this, void 0, void 0, function () {
    var _a, EMULATE;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
