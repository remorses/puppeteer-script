...
exports.makeDoSteps = function (browser, logger) { return ({
        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, _page._client.send('Emulation.clearDeviceMetricsOverride')];
                    case 2:
                        _a.sent();
        ...
        return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, page._client.send('Emulation.clearDeviceMetricsOverride')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, page];
                }
        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, pages[index]._client.send('Emulation.clearDeviceMetricsOverride')];
                    case 5:
                        _a.sent();
    ...
    "set-user-agent": function (page) { return function (userAgent) {
    ...
    "block": function (page) { return function (_a) {
        var requests = _a.requests, responses = _a.responses;
        return __awaiter(_this, void 0, void 0, function () {
            var promises1, promises2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        promises1 = requests.map(function (_a) {
                            var url = _a.to, types = _a.types;
                            return abort_1.abort(browser, types, url);
                        });
                        promises2 = responses.map(function (_a) {
                            var url = _a.from, types = _a.types;
                            return redirect_1.redirect(browser, types, url);
                        });
                        return [4 /*yield*/, Promise.all(__spread(promises1, promises2))];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, page];
                }
    ...
    "redirect": function (page) { return function (_a) {
        var requests = _a.requests, responses = _a.responses, to = _a.to;
        return __awaiter(_this, void 0, void 0, function () {
            var promises1, promises2;
            return __generator(this, function (_b) {
                switch (_b.label) {
