...
exports.fromOBJECT = function (script) { return __awaiter(_this, void 0, void 0, function () {
    var executablePath, headless, requestsToAbort, _a, emulate, options, args, defaults, _b, width, height;
    var _this = this;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                args = script["args"] || [];
                defaults = ['--no-sandbox', '--disable-setuid-sandbox'];
                _b = script["viewport"] || { width: 1000, height: 1000 }, width = _b.width, height = _b.height;
                return [4 /*yield*/, puppeteer_1.launch(__assign({ headless: headless, executablePath: executablePath }, options, { args: __spread(defaults, args), defaultViewport: { width: width, height: height } })).then(function (browser) { return __awaiter(_this, void 0, void 0, function () {
