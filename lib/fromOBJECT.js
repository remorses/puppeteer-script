...
exports.fromOBJECT = function (script) { return __awaiter(_this, void 0, void 0, function () {
    var e_1, _a, options, browser, doSteps, page, func, key, value, _b, _c, step, _d, e_1_1, e_2;
...
var makeOptions = function (script) { return __awaiter(_this, void 0, void 0, function () {
    var defaults, _a, width, height, options;
    return __generator(this, function (_b) {
        ...
        if (script["executable"])
            options.executablePath = script["executable"];
        ...
        switch (_a.label) {
            case 0: return [4 /*yield*/, puppeteer_1.launch(__assign({}, options)).then(function (browser) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!script["emulate"]) return [3 /*break*/, 2];
                                return [4 /*yield*/, emulate_1.emulate(browser, script["emulate"])];
                            case 1:
                                _a.sent();
                                _a.label = 2;
                            case 2:
                                if (!script["abort"]) return [3 /*break*/, 4];
