...
exports.fromOBJECT = function (script) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prepare_1.prepare(script)];
            case 1:
                browser = _a.sent();
                return [4 /*yield*/, browser.pages()];
            case 2:
                page = (_a.sent())[0];
                return [4 /*yield*/, script["do"]
                        .map(function (obj) {
                        var key = Object.keys(obj)[0];
                        var value = obj[key];
                        return { method: key, arg: value };
                    })
                        .reduce(function (state, action) { return __awaiter(_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = reducer_1.reducer;
                                    return [4 /*yield*/, state];
                                case 1: return [4 /*yield*/, _a.apply(void 0, [_b.sent(), action])
                                        .then(function (x) {
