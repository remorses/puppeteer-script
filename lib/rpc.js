                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            _a.label = 2;
                        case 2:
                            if (!(pages.length >= length)) return [3 /*break*/, 4];
                            return [4 /*yield*/, browser.pages()];
                        case 3:
                            pages = _a.sent();
                            setTimeout(function () { return "wait"; }, 200);
                            return [3 /*break*/, 2];
                        case 4: return [4 /*yield*/, pages[length - 1].bringToFront()];
                        case 5: return [2 /*return*/, _a.sent()];
                        case 6:
                            pages[index].close({ runBeforeUnload: true });
                            _a.label = 7;
                        case 7:
                            if (!(pages.length >= length)) return [3 /*break*/, 9];
                            return [4 /*yield*/, browser.pages()];
                        case 8:
                            pages = _a.sent();
                            setTimeout(function () { return "wait"; }, 200);
                            return [3 /*break*/, 7];
                        case 9: return [4 /*yield*/, pages[length - 1].bringToFront()];
